...
from src.Utilities import optimal_parameters, multi_agent_settings, graphics_settings
...
QMIX_HARD_UPDATE_NETWORKS_FREQUENCY = 500
QMIX_BATCH_SIZE = 32
QMIX_EPSILON = 1.0
...
# -------------------------- MAPPO Settings ---------------------------
MAPPO_VALUE_FUNCTION_INPUT_REPRESENTATION = "AS"  # Environment Provided    Agent Specific    Concatenated Local
...
def configure_settings():
    ...
    if multi_agent_settings.AGENT_COUNT == 4 and graphics_settings.LANE_COUNT == 3:
        ENVIRONMENT_SEED = 14
